...
import 'editprofilepage.dart'; // Make sure this import is correct
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  const CircleAvatar(
                    radius: 50,
                    backgroundImage: AssetImage('../assets/helping.jpg'),
                  ),
            ...
            _buildEventCard(
                '../assets/hands2.jpg', 'Event Name 1', 'Oct 10, 2024'),
            _buildEventCard(
                '../assets/help2.jpg', 'Event Name 2', 'Oct 15, 2024'),
            const SizedBox(height: 16),
            const Divider(),

            // Followed Organizations Section
            _buildSectionTitle('Followed Organizations'),
            _buildOrganizationCard('../assets/meds.jpg', 'Organization Name 1',
                'Helping kids in need'),
            _buildOrganizationCard('../assets/volunteers.jpg',
